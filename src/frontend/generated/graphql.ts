...
export type FuzzyTextSearchQuery = {
  __typename?: "Query";
  fuzzyTextSearch: Array<{
    __typename?: "Equipment";
    id: number;
    createdAt: string;
    updatedAt: string;
...
export const FuzzyTextSearch = (
  options: Omit<WatchQueryOptions<FuzzyTextSearchQueryVariables>, "query">
): Readable<
  ApolloQueryResult<FuzzyTextSearchQuery> & {
    query: ObservableQuery<FuzzyTextSearchQuery, FuzzyTextSearchQueryVariables>;
  }
> => {
  const q = client.watchQuery({
...
export const AsyncFuzzyTextSearch = (options: Omit<QueryOptions<FuzzyTextSearchQueryVariables>, "query">) => {
