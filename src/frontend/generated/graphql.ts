...
export type MeQuery = {
  __typename?: "Query";
  me: { __typename?: "User"; id: number; createdAt: string; updatedAt: string; email: string };
};
...
export const FuzzySearch = (
  options: Omit<WatchQueryOptions<FuzzySearchQueryVariables>, "query">
): Readable<
  ApolloQueryResult<FuzzySearchQuery> & {
    query: ObservableQuery<FuzzySearchQuery, FuzzySearchQueryVariables>;
  }
> => {
  const q = client.watchQuery({
...
export const AsyncFuzzySearch = (options: Omit<QueryOptions<FuzzySearchQueryVariables>, "query">) => {
