...
export type Equipment = {
  ...
  id: Scalars['Int'];
  itemArray: Array<Scalars['String']>;
...
export type EquipmentInput = {
  ...
  itemArray?: InputMaybe<Array<Scalars['String']>>;
  manufacturer: Scalars['String'];
  model: Scalars['String'];
...
export type FuzzyTextSearchQuery = { __typename?: 'Query', fuzzyTextSearch: Array<{ __typename?: 'Equipment', id: number, createdAt: string, updatedAt: string, category: string, manufacturer: string, model: string, publicNotes?: string | null, cost?: number | null, powerDraw?: number | null, weight?: number | null, depth?: number | null, rackUnit?: number | null, frequencyRange?: string | null }> };
